...
public class PlayerController : MonoBehaviour
{
	...
	public Animator ani;
	private AudioSource[] teachers;
    private AudioSource[] students;
	...
	void Moving()
	{
		teachers = GameObject.FindGameObjectWithTag ("teacher").GetComponents<AudioSource> ();
		if(!teachers[1].isPlaying){
				teachers[1].Play();
				}
			else{
				teachers[1].UnPause();
	...
	void eyesightCheck()
	{
		students = GameObject.FindGameObjectWithTag ("student").GetComponents<AudioSource> ();
